...
var React = _interopRequireWildcard(__webpack_require__(9052));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(9052);
...
var _react = _interopRequireDefault(__webpack_require__(9052));
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9052);
...
// EXTERNAL MODULE: external "/workspaces/website/node_modules/react/index.js"
var index_js_ = __webpack_require__(9052);
...
const React=__webpack_require__(9052);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(6403);const{parse}=__webpack_require__(698);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(9052),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/workspaces/website/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/workspaces/website/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/workspaces/website/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"app":["/app-d64cbb593d1d6d4f8428.js"]}');
